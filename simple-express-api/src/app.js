...
// Маршрути продуктів - санітизація та валідація ПЕРЕД перевіркою токена
...
// Обробка 404 (без вказівки шляху, щоб уникнути помилок path-to-regexp)
